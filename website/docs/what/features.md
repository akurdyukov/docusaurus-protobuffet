...
- [Protobuffet CLI](https://github.com/akurdyukov/docusaurus-protobuffet/tree/master/packages/docusaurus-protobuffet#cli-commands) to generate markdown ([`.mdx`](https://mdxjs.com/)) files based on a Protobuf file workspace.
- [Docusaurus sidebar object](https://docusaurus.io/docs/sidebar) generation for a navigatable documentation workspace.
- [Docusaurus project scaffolder](https://github.com/akurdyukov/docusaurus-protobuffet/tree/master/packages/docusaurus-protobuffet-init#usage) to initialize a new project with Protobuffet installed.
